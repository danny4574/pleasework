        ...
        <div className="container-fluid py-5">
            <div className="row justify-content-center align-items-start px-4 px-lg-5">
                ...
                <div className="col-lg-6 col-md-6">
                    ...
                    <p className='text-muted text-dexoration-lined-through mb-4'>${product.old_price.toFixed(2)}</p>

                    <p className='mb-4 fs-6 lh-base'>{product.description} || This is a beautiful product you should have. </p>
